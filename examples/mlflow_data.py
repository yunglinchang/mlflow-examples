...
dataset: PandasDataset = mlflow.data.from_pandas(
    df=california_housing_df, source=dataset_source_url, targets=dataset_target, name=dataset_name
)
...
training_dataset_source_url: str = (
    "https://scikit-learn.org/stable/modules/generated/sklearn.datasets.fetch_california_housing.html"
)
...
training_dataset: PandasDataset = mlflow.data.from_pandas(
    df=training_df, source=training_dataset_source_url, targets=training_dataset_target, name=training_dataset_name
)
